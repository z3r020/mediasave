        ...
        faqs={[
          {
            ...
            answer: "Use a supported TikTok video URL. Availability depends on the platform and its permitted access methods.",
          },
          {
      ...
      <section className="mx-auto max-w-3xl px-4 pb-16">
        ...
        <div className="mt-5 space-y-3">
          <details className="rounded-2xl border border-white/10 bg-white/[0.025] p-5">
            ...
            <p className="mt-3 text-sm leading-6 text-slate-400">Use a supported TikTok video URL. Availability depends on the platform and its permitted access methods.</p>
          </details>
          <details className="rounded-2xl border border-white/10 bg-white/[0.025] p-5">
          ...
          <details className="rounded-2xl border border-white/10 bg-white/[0.025] p-5">
            <summary className="cursor-pointer font-semibold">Can I download any TikTok video?</summary>
